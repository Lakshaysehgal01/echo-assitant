            ...
            <UserButton
              ...
              appearance={{
                elements: {
                  ...
                  userButtonBox:
                    "w-full flex-row-reverse justify-end gap-2 text-sidebar-foreground group-data-[collapsible=icon]:justify-center",
